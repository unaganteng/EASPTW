								...
								@else 
										<tr>
											<td class="text-center">
												Tidak ada keranjang yang tersedia. <a href="{{route('product-grids')}}" style="color:blue;">Lanjut Belanja</a>
								...
								<div class="right">
									<ul>
										...
										{{-- <div id="shipping" style="display:none;">
											<li class="shipping">
												Pengiriman {{session('shipping_price')}}
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Simpananmu<span>Rp. {{number_format(Session::get('coupon')['value'],2 , ",", ".")}}</span></li>
										@endif
										@php
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-rocket"></i>
						<h4>GRATIS ONGKIR/h4>
						<p>Pembelian minimal Rp. 100,000</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
